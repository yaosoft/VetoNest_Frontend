...
const ConsultationListVet = () => {
  ...
  const { base_url, allConsultationTypes, allConsultationStatuses, getVetConsultationList, consultationAccept, consultationCancel, consultationFinish, postNotification, getAContent, siteLocale } = useContext(SiteContext);
