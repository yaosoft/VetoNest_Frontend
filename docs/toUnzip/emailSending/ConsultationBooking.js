          ...
          <div style={{ background: "#fff", borderRadius: "14px", padding: "28px", width: "100%", maxWidth: "420px", boxShadow: "0 8px 40px rgba(0,0,0,0.18)" }}>
            {bookingDone ? (
              <div style={{ textAlign: "center" }}>
                ...
                <button onClick={() => { setShowModal(false); navigate('/consultation/vet/list'); }} className="consultation-next-button" style={{ marginTop: "16px" }}>{getAContent('cmp_vetonest.com_Close_Btn')}</button>
              </div>
            ) : (
              <>
